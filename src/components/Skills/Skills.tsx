    ...
    <div className="px-4 pt-1.5 md:pt-2 md:mx-4 lg:mx-auto lg:w-2/3 mx-auto my-8 font-inter font-bold">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="px-6 pt-4 pb-8 mb-3 md:mb-2.5 bg-purple-700 rounded-xl">
          <h3 className="font-semibold text-pink-400 font-inter">Programming languages</h3>
        ...
        <div className="px-4 pt-4 pb-8 mb-2.5 bg-purple-700 rounded-xl">
          <h3 className="font-semibold text-pink-400 font-inter">Libraries & Frameworks</h3>
      ...
      <div className="w-full px-4 pt-1 text-lg bg-purple-700 rounded-xl">
        <span className="text-pink-400 block mt-0.5 font-inter text-center md:text-left font-black">Tools</span>
